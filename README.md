### ✈️Aviation Safety Analysis:  115 Years(1908 - 2024)

**📌Project Overview**

This project provides a data-driven investigation into global aviation safety trends.By processing over 5,000 historical accident records, I conducted an analysis using Python for visual storytelling and SQL for statistics. 
Objective was to identify how technological advancements and regulatory shifts have transformed aviation into the safe industry it is today.
...
* **The Golden Era of Safety**: SQL results confirm the 2010s were the safest decade in history.
